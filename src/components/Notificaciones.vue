...
<template>
  <div class="relative">
    ...
    <Transition name="panel">
      <div
        v-if="panelAbierto"
        class="absolute right-0 top-12 w-80 bg-white rounded-2xl shadow-2xl
        ...
        <div class="max-h-96 overflow-y-auto">
          ...
          <TransitionGroup name="notif" tag="div" class="divide-y divide-gray-50">
            <div
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-gray-500 mt-0.5 line-clamp-2">{{ n.descripcion }}</p>
                <p class="text-xs text-gray-400 mt-1">{{ formatFecha(n.created_at) }}</p>
              </div>
            </div>
          </TransitionGroup>
        </div>
